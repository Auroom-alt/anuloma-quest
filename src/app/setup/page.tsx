...
import { BREATHING_CYCLES, formatDuration, calcTotalSeconds } from '@/constants';

export default function SetupPage() {
  const router = useRouter();
  const { rounds, cycleIndex, setRounds, setCycleIndex } = usePracticeSettings();
  ...
  return (
    <main style={styles.page}>
      <div style={styles.container}>
        ...
        {/* Предупреждение при длинной задержке */}
        {cycle.hold > 30 && (
...
const styles = {
  page: {
    minHeight: '100vh',
    background: 'radial-gradient(ellipse at 30% 40%, rgba(96,165,250,0.06) 0%, transparent 50%), radial-gradient(ellipse at 70% 60%, rgba(167,139,250,0.05) 0%, transparent 50%), #030712',
    display: 'flex',
    alignItems: 'center',
  ...
  selectorRow: {
    ...
    justifyContent: 'center', gap: '1.5rem', marginBottom: '0.75rem',
  },
  ...
  preview: {
    ...
    marginTop: '1.25rem', alignItems: 'flex-end',
  },
  ...
  quoteText: {
    ...
    fontSize: '0.85rem', lineHeight: 1.7, marginBottom: '0.4rem',
  },
